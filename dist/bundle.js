...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsTodoitemlistJs = __webpack_require__(157);

	var _componentsTodoitemlistJs2 = _interopRequireDefault(_componentsTodoitemlistJs);

	var _componentsNewtodoJs = __webpack_require__(159);

	var _componentsNewtodoJs2 = _interopRequireDefault(_componentsNewtodoJs);

	var _componentsFilterbuttonsetJs = __webpack_require__(161);

	var _componentsFilterbuttonsetJs2 = _interopRequireDefault(_componentsFilterbuttonsetJs);
	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	    key: 'addNewTodo',
	    value: function addNewTodo(newTodo) {
	      this.setState({
	        filter: 'ALL',
	    ...
	    key: 'doTodo',
	    value: function doTodo(changedId) {
	      var newTodos = this.state.todos.map(function (todo) {
	        return todo.id === changedId ? _extends({}, todo, { done: !todo.done }) : todo;
	      });
	      this.setState({ filter: 'ALL', todos: newTodos });
	    }
	  }, {
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        null,
	        _react2['default'].createElement(_componentsNewtodoJs2['default'], { handleNewInput: this.addNewTodo.bind(this) }),
	        _react2['default'].createElement(_componentsTodoitemlistJs2['default'], { todosList: this.state.todos,
	          filter: this.state.filter,
	          onTodoDelete: this.removeTodo.bind(this),
	          onCheckboxChange: this.doTodo.bind(this) }),
	        _react2['default'].createElement(_componentsFilterbuttonsetJs2['default'], { handleFiltering: this.filterTodos.bind(this) })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoitemJs = __webpack_require__(158);

	var _todoitemJs2 = _interopRequireDefault(_todoitemJs);

	var TodoItemList = (function (_React$Component) {
	  _inherits(TodoItemList, _React$Component);

	  function TodoItemList() {
	    _classCallCheck(this, TodoItemList);

	    _get(Object.getPrototypeOf(TodoItemList.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(TodoItemList, [{
	    key: 'selectTodos',
	    value: function selectTodos(todos, filter) {
	      switch (filter) {
	        case 'ALL':
	          return todos;
	        case 'UNCHECKED':
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        null,
	        this.props.todosList ? this.selectTodos(this.props.todosList, this.props.filter).map(function (todo) {
	          return _react2['default'].createElement(_todoitemJs2['default'], {
	            key: todo.id,
	            todoItem: todo,
	            onTodoDelete: _this.props.onTodoDelete.bind(_this),
	            onCheckboxChange: _this.props.onCheckboxChange.bind(_this)
	          });
	        }) : _react2['default'].createElement(
	          'p',
	          { className: 'small-8 columns small-centered' },
	          'Zadejte Todo'
	        )
	      );
	    }
	...
	TodoItemList.propTypes = {
	  todosList: _react2['default'].PropTypes.array.isRequired,
	  filter: _react2['default'].PropTypes.string.isRequired,
	  onTodoDelete: _react2['default'].PropTypes.func.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItem = (function (_React$Component) {
	  ...
	  _createClass(TodoItem, [{
	    ...
	    value: function handleDeleteTodo() {
	      event.preventDefault();
	    ...
	    value: function render() {
	      return _react2["default"].createElement(
	        "div",
	        { className: "row", id: this.props.todoItem.id, ref: "todo" },
	        _react2["default"].createElement(
	          "div",
	          { className: "small-8 columns small-centered " },
	          _react2["default"].createElement(
	            ...
	            _react2["default"].createElement("input", { type: "checkbox", checked: this.props.todoItem.done, onClick: this.handleChange.bind(this) })
	          ),
	          _react2["default"].createElement(
	            "div",
	            { className: "small-8 columns", styles: { lineHeight: "35", fontSize: "20" } },
	          ...
	          _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(
	              "a",
	              { href: "#", className: "tiny button alert", styles: { float: "right" }, onClick: this.handleDeleteTodo.bind(this) },
	              "X"
	            )
	          )
	        )
	...
	TodoItem.propTypes = {
	  todoItem: _react2["default"].PropTypes.object.isRequired,
	  onTodoDelete: _react2["default"].PropTypes.func.isRequired,
	  onCheckboxChange: _react2["default"].PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilGetrandomstringJs = __webpack_require__(160);

	var _utilGetrandomstringJs2 = _interopRequireDefault(_utilGetrandomstringJs);
	...
	var NewTodo = (function (_React$Component) {
	  ...
	  _createClass(NewTodo, [{
	    key: 'handleNewTodo',
	    value: function handleNewTodo() {
	      event.preventDefault();
	      var textValue = this.refs.newTodo.getDOMNode().value;
	      if (textValue) {
	        var todo = {
	          id: (0, _utilGetrandomstringJs2['default'])(),
	          text: textValue,
	          done: false
	        };
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'small-6 columns small-offset-2' },
	          _react2['default'].createElement('input', { type: 'text', ref: 'newTodo', placeholder: 'Write todo' })
	        ),
	        _react2['default'].createElement(
	          'div',
	          { className: 'small-2 columns end' },
	          _react2['default'].createElement(
	            'a',
	            { href: '#', className: 'button postfix', onClick: this.handleNewTodo.bind(this) },
	            'Save todo'
	          )
	        )
	      );
	...
	NewTodo.propTypes = {
	  handleNewInput: _react2['default'].PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _filterbuttonJs = __webpack_require__(162);

	var _filterbuttonJs2 = _interopRequireDefault(_filterbuttonJs);

	var FilterButtonSet = (function (_React$Component) {
	  _inherits(FilterButtonSet, _React$Component);

	  function FilterButtonSet() {
	    _classCallCheck(this, FilterButtonSet);

	    _get(Object.getPrototypeOf(FilterButtonSet.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(FilterButtonSet, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'medium-8 columns small-centered ' },
	          _react2['default'].createElement(
	            'ul',
	            { className: 'button-group even-3' },
	            _react2['default'].createElement(
	              _filterbuttonJs2['default'],
	              { handleFiltering: this.props.handleFiltering.bind(this), filter: 'ALL' },
	              'All'
	            ),
	            _react2['default'].createElement(
	              _filterbuttonJs2['default'],
	              { handleFiltering: this.props.handleFiltering.bind(this), filter: 'CHECKED' },
	              'Checked'
	            ),
	            _react2['default'].createElement(
	              _filterbuttonJs2['default'],
	              { handleFiltering: this.props.handleFiltering.bind(this), filter: 'UNCHECKED' },
	              'Unchecked'
	            )
	          )
	        )
	  ...
	  return FilterButtonSet;
	})(_react2['default'].Component);

	FilterButtonSet.propTypes = {
	  handleFiltering: _react2['default'].PropTypes.func.isRequired
	};

	exports['default'] = FilterButtonSet;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilterButton = (function (_React$Component) {
	  ...
	  function FilterButton() {
	    ...
	    _get(Object.getPrototypeOf(FilterButton.prototype), "constructor", this).apply(this, arguments);
	  }
	  ...
	  _createClass(FilterButton, [{
	    ...
	    value: function render() {
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          "a",
	          { href: "#", className: "button secondary", onClick: this.filterTodos.bind(this) },
	          this.props.children
	        )
	      );
	    }
